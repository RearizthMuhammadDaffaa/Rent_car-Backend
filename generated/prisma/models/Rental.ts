...
export type RentalAvgAggregateOutputType = {
  late_fee: runtime.Decimal | null
  damage_fee: runtime.Decimal | null
}
...
export type RentalCountAggregateOutputType = {
  id: number
  Booking_id: number
  actual_pickup_at: number
  actual_return_at: number
  late_fee: number
  damage_fee: number
  Status: number
  createdAt: number
...
export type RentalGroupByOutputType = {
  ...
  late_fee: runtime.Decimal
  damage_fee: runtime.Decimal
...
export type RentalOrderByWithRelationInput = {
  ...
  actual_pickup_at?: Prisma.SortOrder
  actual_return_at?: Prisma.SortOrder
  late_fee?: Prisma.SortOrder
...
export type RentalScalarWhereWithAggregatesInput = {
  ...
  Booking_id?: Prisma.StringWithAggregatesFilter<"Rental"> | string
  actual_pickup_at?: Prisma.DateTimeWithAggregatesFilter<"Rental"> | Date | string
  actual_return_at?: Prisma.DateTimeWithAggregatesFilter<"Rental"> | Date | string
  late_fee?: Prisma.DecimalWithAggregatesFilter<"Rental"> | runtime.Decimal | runtime.DecimalJsLike | number | string
  damage_fee?: Prisma.DecimalWithAggregatesFilter<"Rental"> | runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type RentalCreateInput = {
  ...
  booking: Prisma.BookingsCreateNestedOneWithoutRentalInput
}
...
export type RentalUpdateInput = {
  ...
  booking?: Prisma.BookingsUpdateOneRequiredWithoutRentalNestedInput
}
...
export type RentalCreateWithoutBookingInput = {
  id?: string
  actual_pickup_at: Date | string
  actual_return_at: Date | string
  late_fee: runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type RentalUncheckedCreateWithoutBookingInput = {
  id?: string
  actual_pickup_at: Date | string
  actual_return_at: Date | string
  late_fee: runtime.Decimal | runtime.DecimalJsLike | number | string
...
export type RentalCreateOrConnectWithoutBookingInput = {
...
export type RentalSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  id?: boolean
  Booking_id?: boolean
  actual_pickup_at?: boolean
  actual_return_at?: boolean
  late_fee?: boolean
  damage_fee?: boolean
  Status?: boolean
  createdAt?: boolean
...
export type RentalOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "Booking_id" | "actual_pickup_at" | "actual_return_at" | "late_fee" | "damage_fee" | "Status" | "createdAt" | "updatedAt", ExtArgs["result"]["rental"]>
...
export interface RentalFieldRefs {
  ...
  readonly Booking_id: Prisma.FieldRef<"Rental", 'String'>
  readonly actual_pickup_at: Prisma.FieldRef<"Rental", 'DateTime'>
  readonly actual_return_at: Prisma.FieldRef<"Rental", 'DateTime'>
  readonly late_fee: Prisma.FieldRef<"Rental", 'Decimal'>
  readonly damage_fee: Prisma.FieldRef<"Rental", 'Decimal'>
